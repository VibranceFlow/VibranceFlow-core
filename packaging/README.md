...
3. Output: `dist/LuminaSync.exe` (standalone folder or onefile per script flags)
...
2. Layout `LuminaSync.AppDir` with `AppRun`, `.desktop`, icon, and binary.
3. Run `appimagetool` to produce `LuminaSync.AppImage`.
